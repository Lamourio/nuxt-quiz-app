    ...
    <div class="main">
      ...
      <div v-if="website.status.loading === false && website.status.message === ''" id="quizContainer" class="container">
        ...
        <div class="navigation-buttons">
          <v-button :onClick="() => navigate(-1)" :isDisabled="currentQuestionIndex === 0">Previous</v-button>
          <v-button :onClick="() => navigate(1)" :isDisabled="currentQuestionIndex === website.result.length - 1">Next</v-button>
        </div>
      </div>
    </div>
    <footer class="footer">
      <div class="footer-content">
        ...
        <div class="footer-actions">
          <v-button :onClick="submitQuiz" :isDisabled="currentQuestionIndex !== website.result.length - 1">Submit</v-button>
        </div>
      </div>
    </footer>
  </main>
